    ...
    <div className="min-h-screen bg-slate-50 py-12 px-6">
      <div className="w-full max-w-4xl mx-auto bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-slate-200 flex flex-col gap-12 animate-in fade-in zoom-in-95 duration-500">
        <div className="text-center border-b border-slate-100 pb-10">
          ...
          <p className="font-sans text-sm text-slate-400 m-0 mt-4 uppercase tracking-widest font-bold">
        ...
        <div className="flex flex-col items-center gap-4 py-10 bg-slate-50 rounded-2xl border border-slate-100 shadow-inner group">
          <div
            className="w-40 h-40 rounded-full border-[10px] bg-white flex flex-col items-center justify-center shadow-xl transition-transform group-hover:scale-105 duration-500"
          ...
          >
            ...
            <span className="font-sans text-xs font-black text-slate-300 mt-2 uppercase tracking-tighter">
              / 100
            </span>
          </div>
            ...
            <div className="p-8 rounded-2xl border border-amber-100 bg-amber-50/30 flex flex-col gap-6 shadow-sm">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-amber-100 flex items-center justify-center">
                  <BsArrowUpRight className="text-xl text-amber-600" />
                </div>
                <h2 className="font-serif text-xl text-slate-900 m-0">
          ...
          <div className="p-8 rounded-2xl border border-blue-100 bg-blue-50/30 flex flex-col gap-6 shadow-sm relative overflow-hidden">
            ...
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center">
                <BsJournalText className="text-xl text-blue-600" />
              </div>
              <h2 className="font-serif text-xl text-slate-900 m-0">
                Final Assessment
              </h2>
